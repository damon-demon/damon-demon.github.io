...
def info():
    ...
    print
    'Python: %s, located at %s.' % (sys.version[:5], sys.executable)
    print
    'Equation support:',
    ...
    for (r, wl) in rs:
        ...
        while m:
            ...
            if f.baseline is None:
                ...
                if not supported:
                    print
                    'WARNING: equation support disabled.'
                    print
                    message
                    f.eqsupport = False
                    return b
